...
new reply: maria notified

maria configs category: new topics

new reply: not notified

new topic: yes notified

new reply in topic: not notified

maria watches topic

new reply in topic: yes notified

maria changes to inherit

new reply in topic: not notified

maria changes cat to inherit

new reply in topic: yes notified

maria clears site wide
...
Maria configs Gen cat: Every post
Trillian configs Gen cat: Muted
Owen posts a reply —> only Maria notfd.
Maria configs Gen cat: Muted
(Owen posts a reply —> No one notfd)



Owen configs Trusted Members, single page: Every Post.
Owen posts a reply —> Trillian notfd.

Maria configs page: Every post
Trillian configs page: Muted
Owen posts a reply —> only Maria notfd.
Maria configs page: Muted
Trillian clears her config, fallbacks to Trusted: every post.
Owen posts a reply —> Trillian notfd
